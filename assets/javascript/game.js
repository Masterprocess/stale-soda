...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	function riddleMeThis() {
		un = new mrMinutiae("What is the name of the main character in Beyond Good and Evil?",
                            ["Woof", "Pey'j", "Double H", "Jade"],
                            "Jade",
							 "assets/images/jade.jpg");
		deux = new mrMinutiae("What is Jade's occupation?", 
                            ["Photographer", "Barmaid", "Police Officer", "Pro Dog Petter"],
							"Photographer",
							"assets/images/boss.png");
		trois = new mrMinutiae("Who composed the soundtrack of Beyond Good and Evil?",
								["Woof", "Yves Guillemot", "Christophe Heral", "Shigeru Miyamoto"],
								"Christophe Heral",
								"assets/images/Woof.jpg");
		quatre = new mrMinutiae("What is the name of Jade's spaceship?",
								["Suck-it-Miyamoto", "Space Doggy", "The Fortune", "The Beluga"],
								"The Beluga",
								"assets/images/beluga.jpg");
		cinq = new mrMinutiae("Why are there human-animal hybrids?",
								["Humans needed a new form of slavery for space colonization", "Because the wealthy wanted to talk to their dogs", "Because it's just a game and not everything needs a reason","They're actually just aliens that resemble human animals"],
								"Humans needed a new form of slavery for space colonization",
								"assets/images/peyj.jpg");
		six = new mrMinutiae("Why did Beyond Good and Evil fail commercially?",
		["It was released the same day as The Prince of Persia",
		"Because the marketing was poor",
		"Because the doggy wasn't shown off in trailers",
		"All of the above"],
		"All of the above",
		"assets/images/kbups.jpg");
		sept = new mrMinutiae("Who is the main enemy in Beyond Good and Evil?",
		["Dog Haters United!", "The IRIS Network", "Shigeru Miyamoto", "The Dom'z"],
		"The Dom'z",
		"assets/images/hillys.png");
		huit = new mrMinutiae("How many platforms has Beyond Good and Evil been released on?",
		["6", "4", "3", "8"],
		"6",
		"assets/images/nino.jpg");
		neuf = new mrMinutiae("How many PA-1s can be acquired in Beyond Good and Evil?",
		["1", "13", "14", "Virtually infinite"],
		"13",
		"assets/images/mei.jpg");
		dix = new mrMinutiae("What is the name of the moon above Hillys?",
		["Selene", "Luna", "Karl Marx","Dog Heaven"],
		"Selene",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////	
	...
	function select(choice) {
		choice.css({"font-size":"18pt", "background": "green" });
